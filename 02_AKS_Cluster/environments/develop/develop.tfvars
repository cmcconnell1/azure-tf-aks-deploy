...
tf_generated_key_vault_name = "kv-developaksterraform"
tf_generated_resource_group = "rg-developaksterraform"
...
ingress_nginx_azure_tenant_id = "xxxxxxxxx"
...
# 'id-{ENV}aksterraform-pod' i.e.: id-developaksterraform-pod
# NOTE: THIS identity must have Get,List access to the existing env-specific keyvaults--i.e.  developAksKeyVault2022 and for other envs their requisite env-specific keyvault
...
# the Pod Identity
# for develop:    id-developaksterraform-pod
#
# needs to have access the Resource / Keyvault
# for develop:    developAksKeyVault2022 kv-developaksterraform
#aad_pod_identity_name = "podidentity"
#existing_keyvault_id="/subscriptions/xxxxxxx/resourceGroups/developAksKeyVault2022/providers/Microsoft.KeyVault/vaults/developAksKeyVault2022"

ingress_nginx_primary_akv_name = "developAksKeyVault2022"
# primary cert for subdomain the new order
ingress_nginx_primary_cert_name = "develop-mycompany-com-chain"
