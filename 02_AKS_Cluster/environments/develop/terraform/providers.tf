# ref: /Users/cmcconnell/development/penumbra/test-aks-github-actions/terraform/providers.tf
...
terraform {
  ...
  backend "azurerm" {
      ...
      container_name       = "develop-aks-cluster-tfstate"
      key                  = "develop-aks-cluster-tfstate"
  }
}
