...
#variable "existing_keyvault_id" {
#  type = string
#  description = "the resource-id of the existing environment-specific keyvault i.e. for developAksKeyVault2022, that we need to grant access to our SP to Get,List."
#}
